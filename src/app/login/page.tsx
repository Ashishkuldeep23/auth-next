        ...
        <>
            <div className=' w-full h-screen flex flex-col items-center py-[25vh]'>
                ...
                <div className=' border px-4 py-4 rounded-md md:w-1/4'>
                    ...
                    <p className=' text-4xl font-bold border-b text-center px-5 py-1 rounded-md '>LogIn</p>
                    ...
                    <div className=' flex'>
                        ...
                        <button className=' px-4 border bg-green-400 text-white font-semibold mt-3 rounded ml-auto mr-10'>LogIn</button>
